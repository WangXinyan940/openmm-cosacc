extern "C" __global__ 
void addForces(const FORCES_TYPE* __restrict__ massvec, const real4* __restrict__ posq, long long* __restrict__ forceBuffers, int* __restrict__ atomIndex, FORCES_TYPE A, int numAtoms, int paddedNumAtoms) {
